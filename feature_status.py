...
def build_feature_status(media_type=None, has_gps=False, has_capture_date=False):
    ...
    return [
        ...
        {"Capability": "Road-condition detection", "Status": "Implemented", "Evidence": "active model profile"},
        ...
        {"Capability": "Temporal tracking and duplicate suppression", "Status": "Implemented", "Evidence": "temporal_tracking.py"},
        {"Capability": "Road-damage evidence cards", "Status": "Implemented", "Evidence": "evidence_cards.py"},
        {"Capability": "Road-condition health score", "Status": "Implemented", "Evidence": "health_score.py"},
        {"Capability": "Smart repair queue", "Status": "Implemented", "Evidence": "repair_queue.py"},
        {"Capability": "Road segment analytics", "Status": "Implemented", "Evidence": "segment_analytics.py"},
        {"Capability": "Inspection comparison", "Status": "Implemented", "Evidence": "inspection_comparison.py"},
        {"Capability": "Explainable severity and risk", "Status": "Implemented", "Evidence": "explainable_risk.py"},
        {"Capability": "Confidence calibration", "Status": "Implemented", "Evidence": "confidence_calibration.py"},
        {"Capability": "Mission replay", "Status": "Implemented", "Evidence": "mission_replay.py"},
        {"Capability": "PDF inspection report", "Status": "Implemented", "Evidence": "inspection_report.py"},
        {"Capability": "GPS and data-quality layer", "Status": "Implemented", "Evidence": "data_quality.py"},
        {"Capability": "Active-learning feedback selection", "Status": "Implemented", "Evidence": "active_learning.py"},
    ]
